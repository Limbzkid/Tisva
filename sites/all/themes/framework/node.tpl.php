...
/*------------------------------------------------------------------------------------------------------------------------*/
		...
		<div class="prdctTabsWrap">
			<ul class="tabs">
				...
				<li><a href="javascript:;">Technical <br> Specs</a></li>
			</ul>
			...
			<div class="tabContent">
				...
				<div class="formWrap">
					<div class="fieldWrap">
						<input name="mobile" type="tel" onblur="clearText(this)" onfocus="clearText(this)" value="Enter Your Mobile" class="inputWrap mobileNo" maxlength="10">
