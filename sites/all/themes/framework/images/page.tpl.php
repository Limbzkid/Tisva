<?php
	global $base_url;
	$i = 0;
	foreach($page['content']['system_main']['search_results']['#results'] as $row) {
		$temp = parse_url($row['link']);
		$page['content']['system_main']['search_results']['#results'][$i]['link'] = $base_url.$temp['path'];
		$i++;
	}
?>
